...
<section class="py-5 welcome-section" id="welcome-section">
  <div class="container welcome-container" id="welcome-section">
      ...
      <div class="row mb-5 align-items-center">
        ...
        <div class="col-md-6 d-flex justify-content-center">
          <div id="slider" class="position-relative overflow-hidden rounded" style="max-width: 100%;">
            <img src="{{ asset('images/maskot/2012.webp') }}" class="img-slide img-fluid w-100 d-block" alt="Slide 1">
          </div>
        </div>
      </div>
    ...
    <div class="text-center mb-5">
      <h2 class="fw-bold" style="color: #B8141E;">AFTER MOVIE SIPA FESTIVAL 2012</h2>
      <div class="position-relative d-inline-block mt-4" style="cursor: pointer; max-width: 2560px;">
        <div id="thumbnail" onclick="openVideo()" style="position: relative;">
          <img src="{{ asset('images/gallery/2012/2012.jpg') }}" class="img-fluid rounded-5" alt="On SIPA Last Year">
        ...
        <iframe id="videoIframe" width="1280" height="720"
                src="https://www.youtube.com/embed/WoHFAlZ4wtA"
        ...
        <div class="row justify-content-center text-center">
            ...
            <div class="col-6 col-md-3 mb-4">
                <div class="card border-0">
                    <img src="{{ asset('images/gallery/2012/a.webp') }}" class="img-fluid custom-rounded" alt="Foto 1">
                </div>
            </div>
            <div class="col-6 col-md-3 mb-4">
                <div class="card border-0">
                    <img src="{{ asset('images/gallery/2012/b.webp') }}" class="img-fluid custom-rounded" alt="Foto 2">
                </div>
            </div>
            <div class="col-6 col-md-3 mb-4">
                <div class="card border-0">
                    <img src="{{ asset('images/gallery/2012/c.webp') }}" class="img-fluid custom-rounded" alt="Foto 3">
                </div>
            </div>
            <div class="col-6 col-md-3 mb-4">
                <div class="card border-0">
                    <img src="{{ asset('images/gallery/2012/d.webp') }}" class="img-fluid custom-rounded" alt="Foto 4">
                </div>
            </div>
            <div class="col-6 col-md-3 mb-4">
                <div class="card border-0">
                    <img src="{{ asset('images/gallery/2012/e.webp') }}" class="img-fluid custom-rounded" alt="Foto 5">
                </div>
            </div>
            <div class="col-6 col-md-3 mb-4">
                <div class="card border-0">
                    <img src="{{ asset('images/gallery/2012/f.webp') }}" class="img-fluid custom-rounded" alt="Foto 6">
                </div>
            </div>
            <div class="col-6 col-md-3 mb-4">
                <div class="card border-0">
                    <img src="{{ asset('images/gallery/2012/g.webp') }}" class="img-fluid custom-rounded" alt="Foto 7">
                </div>
            </div>
        </div>
    </div>
...
<script>
  ...
  const youtubeLink = "https://www.youtube.com/embed/WoHFAlZ4wtA?autoplay=1"; // Autoplay enabled
